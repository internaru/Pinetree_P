...
#define  HPDF_COMP_NONE            0x00		//All contents are not compressed. 
#define  HPDF_COMP_TEXT            0x01		//Compress the contents stream of the page.   
#define  HPDF_COMP_IMAGE           0x02		//Compress the streams of the image objects.  
#define  HPDF_COMP_METADATA        0x04		//Other stream datas (fonts, cmaps and so on)  are compressed.
#define  HPDF_COMP_ALL             0x0F		//All stream datas are compressed. (The same as "HPDF_COMP_TEXT | HPDF_COMP_IMAGE | HPDF_COMP_METADATA")
