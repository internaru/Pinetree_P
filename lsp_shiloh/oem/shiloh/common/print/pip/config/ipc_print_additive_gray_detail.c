...
{
    .cfg_mode = IPC_PRINT_ADDITIVE_GRAY8_DETAIL,
    .cfg_name = "Mono Print Detail additive 1bit",
...
//    .th_cfg[3] = &th_106lpi_1bit_cfg,     // Halftone (Threshold)  lsptodo: 141lpi needs repair.
    ...
    .onedlut4 = (uint8_t *)PA_inverse, // 1D LUT 4  invert additive input
