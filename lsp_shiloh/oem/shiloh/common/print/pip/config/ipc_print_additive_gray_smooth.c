...
/// 8bit additive gray ==> 2bit K threshold 
{
    .cfg_mode = IPC_PRINT_ADDITIVE_GRAY8_SMOOTH,
    .cfg_name = "Mono Print Smooth additive 2bit",
    ...
    .th_cfg[3] = &th_141lpi_2bit_cfg, //&th_106lpi_1bit_cfg,        // Halftone (Threshold)
    ...
    .onedlut4 = (uint8_t *)PA_inverse, // additive inverted to subtractive  
