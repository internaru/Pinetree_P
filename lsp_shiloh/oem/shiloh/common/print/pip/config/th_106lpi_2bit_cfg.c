...
th_ucell_cfg_t th_ucell_106_2bit =
{
  .bpp         = 2,
  .concat      = 0, 
  .height      = 8,
  ...
  .thresh_hi   = 0xff00,
  .thresh_lo   = 0x0100,
  .lut_minval  = 144, //272, //272, // 144,
  .lut_maxval  = 1167,// 9487, //10503, // 5455, // 1167,
  .lut_data    = {0},
...
th_cfg_t th_106lpi_2bit_cfg =
{
    ...
    .pw_mux_bpp_conv    = 1,  // (0 => 1bpp, 1 => 2bpp, 2 => 3bpp, 3 => 4bpp)
    .edge_override      = 1,
    .thresh_edge        = 0,
    .thresh_pw          = 0,
    .LFSR               = 0,

    .ucell0         = &th_ucell_106_2bit,
    .ucell1         = &th_ucell_zero_2bit, // &th_ucell_106_2bit,
