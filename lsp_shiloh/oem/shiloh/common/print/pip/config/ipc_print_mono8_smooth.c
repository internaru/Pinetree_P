...
/// 8bit subtractive gray ==> 2 bit K threshold
{
    .cfg_mode = IPC_PRINT_MONO8_SMOOTH,
    .cfg_name = "Mono print smooth subtractive 2bit threshold",
    ...
    .th_cfg[0] = &th_106lpi_1bit_cfg,        // not used
    .th_cfg[1] = &th_106lpi_1bit_cfg,        // not used 
    .th_cfg[2] = &th_106lpi_1bit_cfg,        // not used
    .th_cfg[3] = &th_141lpi_2bit_cfg,        // 
    ...
    .onedlut4 = (uint8_t *)PA_identity, // subtractive gets identity
