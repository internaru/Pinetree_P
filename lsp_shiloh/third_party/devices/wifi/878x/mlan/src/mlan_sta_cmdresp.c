                          ...
                          IN mlan_ioctl_req * pioctl_buf)
{
    ...
    if (pioctl_buf != MNULL) {
        ...
        MOAL_MEMSET(pmpriv->adapter, &pget_info->param.signal, 0,
                            ...
                            IN mlan_ioctl_req * pioctl_buf)
{
    ...
    MOAL_MEMCPY(pmpriv->adapter, pmpriv->curr_addr, pmac_addr->mac_addr,
    ...
    if (pioctl_buf) {
        ...
        MOAL_MEMCPY(pmpriv->adapter, &bss->param.mac_addr, pmpriv->curr_addr,
               MLAN_MAC_ADDR_LENGTH);
        pioctl_buf->data_read_written =
                               ...
                               IN mlan_ioctl_req * pioctl_buf)
{
    ...
    if (!MOAL_MEMCMP(pmadapter, resp->params.deauth.mac_addr,
        ...
        if (action == HostCmd_ACT_GEN_GET) {
            while (tlv_buf_len > 0) {
                ...
                case TLV_TYPE_SSID:
                    ...
                    MOAL_MEMCPY(pmpriv->adapter, sec->param.passphrase.ssid.ssid,
                ...
                case TLV_TYPE_BSSID:
                    ...
                    MOAL_MEMCPY(pmpriv->adapter, &sec->param.passphrase.bssid,
                ...
                case TLV_TYPE_PMK:
                    ...
                    MOAL_MEMCPY(pmpriv->adapter, sec->param.passphrase.psk.pmk.pmk,
        ...
        case HostCmd_CMD_802_11_EEPROM_ACCESS:
            {
                ...
                if (eeprom->byte_count > 0) {
                    MOAL_MEMCPY(pmadapter, &eeprom->value, &cmd_eeprom->value,
                           eeprom->byte_count);
