...
#define MLAN_RELEASE_VERSION		"221.p8"
...
/** Control bit for uAP 11n feature */
#define FEATURE_CTRL_UAP_11N        MBIT(0)
/** Control bit for Ad-Hoc 11n feature */
#define FEATURE_CTRL_ADHOC_11N      MBIT(1)
/** Control bit for WAPI feature */
#define FEATURE_CTRL_WAPI           MBIT(2)
/** Control bit for BSS mode set feature */
#define FEATURE_CTRL_BSS_MODE       MBIT(3)
/** Control bit for initial ps mode feature */
#define FEATURE_CTRL_INIT_PS_MODE        MBIT(5)
