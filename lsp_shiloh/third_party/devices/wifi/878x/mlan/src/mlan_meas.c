                             ...
                             const HostCmd_DS_COMMAND * resp)
{
    ...
    if (pmadapter->state_meas.meas_rpt_pend_on
        ...
        MOAL_MEMCPY(pmadapter, &pmadapter->state_meas.meas_rpt_returned, pmeas_rpt,
                      ...
                      HostCmd_DS_COMMAND * pcmd_ptr, const void *pinfo_buf)
{
    ...
    MOAL_MEMCPY(pmpriv->adapter, &pcmd_ptr->params.meas_req, pmeas_req,
...
wlan_meas_cmd_get_report(mlan_private * pmpriv, HostCmd_DS_COMMAND * pcmd_ptr)
{
    ...
    MOAL_MEMSET(pmpriv->adapter, &pcmd_ptr->params.meas_rpt, 0x00,
     ...
     */
    MOAL_MEMCPY(pmpriv->adapter, pcmd_ptr->params.meas_rpt.mac_addr,
