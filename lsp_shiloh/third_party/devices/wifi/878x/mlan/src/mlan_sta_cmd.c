                      ...
                      IN t_u16 cmd_action, IN t_void * pdata_buf)
{
    ...
    case HostCmd_ACT_GEN_SET:
        ...
        if (ptxp->mode) {
            ...
            MOAL_MEMMOVE(pmpriv->adapter, ptxp_cfg, pdata_buf,
                    sizeof(HostCmd_DS_TXPWR_CFG) +
                            ...
                            IN HostCmd_DS_COMMAND * cmd, IN t_u16 cmd_action)
{
    ...
    if (cmd_action == HostCmd_ACT_GEN_SET) {
        MOAL_MEMCPY(pmpriv->adapter, cmd->params.mac_addr.mac_addr,
                           ...
                           IN t_u16 cmd_action, IN t_void * pdata_buf)
{
    ...
    MOAL_MEMCPY(pmpriv->adapter, pmc_addr->mac_list, pmcast_list->mac_list,
                               ...
                               IN t_void * pdata_buf)
{
    ...
    /* Set AP MAC address */
    MOAL_MEMCPY(pmpriv->adapter, pdeauth->mac_addr, (t_u8 *) pdata_buf,
...
#define KEYPARAMSET_WEP_FIXED_LEN 8
            ...
            MOAL_MEMMOVE(priv->adapter, &key_param_set->key[2],
                               ...
                               IN t_u16 cmd_action, IN t_void * pdata_buf)
{
    ...
    if (psk->ssid.ssid_len) {
        ...
        MOAL_MEMCPY(pmpriv->adapter, (char *) pssid_tlv->ssid, psk->ssid.ssid,
               psk->ssid.ssid_len);
    ...
    if (MOAL_MEMCMP
        ...
        MOAL_MEMCPY(pmpriv->adapter, pbssid_tlv->bssid, (t_u8 *) & psk->bssid,
               MLAN_MAC_ADDR_LENGTH);
    ...
    if (psk->psk_type == MLAN_PSK_PASSPHRASE) {
        ...
        MOAL_MEMCPY(pmpriv->adapter, ppassphrase_tlv->passphrase,
    ...
    if (psk->psk_type == MLAN_PSK_PMK) {
        ...
        MOAL_MEMCPY(pmpriv->adapter, ppmk_tlv->pmk, psk->psk.pmk.pmk,
               MLAN_MAX_KEY_LENGTH);
                      ...
                      IN t_u16 cmd_action, IN t_void * pdata_buf)
{
    ...
    if (pmgmt_ie_list->ds_mgmt_ie.ie_data_list && cust_ie->ie_data_list) {
        ...
        if (cust_ie->len)
            MOAL_MEMCPY(pmpriv->adapter, pmgmt_ie_list->ds_mgmt_ie.ie_data_list,
...
wlan_ops_sta_init_cmd(IN t_void * priv, IN t_u8 first_bss)
{
    ...
    MOAL_MEMSET(pmpriv->adapter, &amsdu_aggr_ctrl, 0, sizeof(amsdu_aggr_ctrl));
