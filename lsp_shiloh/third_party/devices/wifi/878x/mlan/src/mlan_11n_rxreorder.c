                              ...
                              int win_size, int seq_num)
{
    ...
    if ((rx_reor_tbl_ptr = wlan_11n_get_rxreorder_tbl(priv, tid, ta))) {
        ...
        new_node->tid = tid;
        MOAL_MEMCPY(pmadapter, new_node->ta, ta, MLAN_MAC_ADDR_LENGTH);
                       ...
                       HostCmd_DS_COMMAND * cmd, t_void * pdata_buf)
{
    ...
    MOAL_MEMCPY(priv->adapter, padd_ba_req, pdata_buf,
                          ...
                          HostCmd_DS_COMMAND * cmd, void *pdata_buf)
{
    ...
    MOAL_MEMCPY(priv->adapter, padd_ba_rsp->peer_mac_addr,
                   ...
                   HostCmd_DS_COMMAND * cmd, void *pdata_buf)
{
    ...
    MOAL_MEMCPY(priv->adapter, pdel_ba, pdata_buf, sizeof(HostCmd_DS_11N_DELBA));
                           ...
                           HostCmd_DS_11N_BATIMEOUT * event)
{
    ...
    MOAL_MEMSET(priv->adapter, &delba, 0, sizeof(HostCmd_DS_11N_DELBA));
    MOAL_MEMCPY(priv->adapter, delba.peer_mac_addr, event->peer_mac_addr,
