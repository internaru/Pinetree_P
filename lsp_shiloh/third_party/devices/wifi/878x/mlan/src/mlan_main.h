...
#endif
#else
#define	ENTER()			dprintf("Enter: %s\n", __FUNCTION__)
#define	LEAVE()			dprintf("Leave: %s\n", __FUNCTION__)
#endif
...
/** Check if uAP 11n enabled */
#define IS_UAP_11N(x)       ((x) & FEATURE_CTRL_UAP_11N)
/** Check if Ad-hoc 11n enabled */
#define IS_ADHOC_11N(x)     ((x) & FEATURE_CTRL_ADHOC_11N)
/** Check if WAPI enabled */
#define IS_WAPI(x)          ((x) & FEATURE_CTRL_WAPI)
/** Check if set BSS mode command allowed */
#define IS_BSS_MODE(x)      ((x) & FEATURE_CTRL_BSS_MODE)
/** Check if set ps mode command allowed */
#define IS_INIT_PS_MODE(x)      ((x) & FEATURE_CTRL_INIT_PS_MODE)
