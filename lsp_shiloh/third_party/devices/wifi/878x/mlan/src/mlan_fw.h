...
//NOTE!! : Changing the default power save mode to PSP was causing problems with the NetGear WNA1100, N150 USB Wifi adapter 
//while running the WHQL vertical pairing test. Setting this to CAM (disabled) mode. 
