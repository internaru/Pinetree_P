			       ...
			       u8 *msg, size_t msg_len, u8 *key_mic)
{
    ...
    if (os_memcmp(dest, test_addr, ETH_ALEN) == 0 &&
        os_memcmp(sm->bssid, test_addr, ETH_ALEN) == 0) {
#endif
		/*
				      ...
				      struct wpa_ptk *ptk)
{
    ...
    dbg_printf("WPA: Sending EAPOL-Key 2/4\n");
					  ...
					  u16 ver)
{
    ...
    dbg_printf("WPA: RX message 1 of 4-Way Handshake from "
				      ...
				      struct wpa_ptk *ptk)
{
    ...
    dbg_printf("WPA: Sending EAPOL-Key 4/4\n");
	wpa_eapol_key_send(sm, ptk->kck, ver, dst, ETH_P_EAPOL,
			   rbuf, rlen, reply->key_mic);
					  ...
					  u16 ver)
{
    ...
    dbg_printf("WPA: RX message 3 of 4-Way Handshake from "
					     ...
					     struct wpa_gtk_data *gd)
{
    ...
    dbg_printf("WPA RSN: msg 1/2 key data\n");
				      ...
				      int ver, u16 key_info)
{
    ...
    dbg_printf("WPA: Sending EAPOL-Key 2/2\n");
