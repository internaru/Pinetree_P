...
/**
 * @brief Get wireless STA interface current link status
 *
 * This routine gets the wireless STA interface current link status
 *
 */
uint32_t wifi_intf_sta_get_current_link_status(void);

/**
 * @brief Get wireless uAP interface current link status
 *
 * This routine gets the wireless uAP interface current link status
 *
 */
