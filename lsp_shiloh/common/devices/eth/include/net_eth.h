...
#include "eth_phy_api.h" // TODO TEMP
...
typedef struct
{
    ...
    // statistical running totals
    eth_mac_rx_stats_t  rx_stats;
    eth_mac_tx_stats_t  tx_stats;
    ...
    uint32_t net_eth_pwr_mgr_uid;
    uint32_t net_eth_pwr_mgr_event_flag;
 ...
 */
typedef void (*net_eth_notify_callback_t)( uint16_t ether_type );
