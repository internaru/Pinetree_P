 ...
 **************************************************************************************
 *
 * \file ICE_test_regstructs.h
 * Generated using RegBuild 1.6.1
 *
 *************************************************************************
 */

#ifndef _ICE_TEST_REGSTRUCTS_H_
#define _ICE_TEST_REGSTRUCTS_H_
...
typedef struct ICE_TEST_REGS_s
{
  volatile uint32_t TestConfig;  ///< 0x0 [R/W]: ICE Test Configuration Register
  volatile uint32_t reserved0[3];
  volatile uint32_t IntEn;  ///< 0x10 [R/W]: Interrupt Enable
  volatile uint32_t IntPend;  ///< 0x14 [R]: Interrupt Pending
  volatile uint32_t IntAck;  ///< 0x18 [W]: Interrupt Acknowledge
  volatile uint32_t IntForce;  ///< 0x1c [W]: Interrupt Force
} ICE_TEST_REGS_t;
...
typedef struct TESTIDMA_REGS_s
{
