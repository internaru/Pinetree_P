 ...
 **************************************************************************************
 *
 * \file COLOR_SHIFT_regstructs.h
 * Generated using RegBuild 1.6.1
 *
 *************************************************************************
 */

#ifndef _COLOR_SHIFT_REGSTRUCTS_H_
#define _COLOR_SHIFT_REGSTRUCTS_H_
...
typedef struct COLOR_SHIFT_REGS_s
{
  ...
  volatile uint32_t CCSRSR;  ///< 0x14 [R]: CIS Color Shift Row Status Register
} COLOR_SHIFT_REGS_t;
