 ...
 */
  ...
  * \file asic.h 
  *  
  * \brief Master Granite2 ASIC include file. 
  *  
  */
...
#include "APB2_regmasks.h"
#include "APB2_regstructs.h"
...
#include "CDMA_Top_Reg_regmasks.h"
#include "CDMA_Top_Reg_regstructs.h"
...
#include "PIP_TOP_regmasks.h"
#include "PIP_TOP_regstructs.h"
#define PIP_PIP_BASE IPS_PIP_BASE
#include "Zx_regmasks.h"
#include "Zx_regstructs.h"
#define ZX_BASE IPS_ZX_BASE

#define NGADJUST_DAVINCI_REGS_t NGA_REGS_t
...
#define PIP_ODMA0_BASE IPS_PIP_ODMA0_BASE 
#define PIP_ODMA1_BASE IPS_PIP_ODMA1_BASE 
#define PIP_ODMA2_BASE IPS_PIP_ODMA2_BASE 
#define PIP_ODMA3_BASE IPS_PIP_ODMA3_BASE 
#define PIP_ODMA4_BASE IPS_PIP_ODMA4_BASE 
#define PIP_ODMA5_BASE IPS_PIP_ODMA5_BASE 
#define PIP_ODMA6_BASE IPS_PIP_ODMA6_BASE 
#define PIP_ODMA7_BASE IPS_PIP_ODMA7_BASE 
#define PIP_ODMA8_BASE IPS_PIP_ODMA8_BASE 

#define PIP_PA_PA_ODMA_BASE IPS_PIP_PA_PA_ODMA_BASE

#define PIPE_ACCESS_REGS_t PA_PA_CORE_REGS_t
#define PIP_PA_BASE IPS_PIP_PA_PA_CORE_BASE
#define PIPE_ACCESS PA_PA_CORE
#define PA_ODMA_REGS_t PA_PA_ODMA_REGS_t

#define PIP_TH0_CORE_BASE IPS_PIP_HTH0_CORE_BASE
#define PIP_TH0_SRAM_BASE IPS_PIP_HTH0_SRAM_BASE
#define PIP_TH1_CORE_BASE IPS_PIP_HTH1_CORE_BASE
#define PIP_TH1_SRAM_BASE IPS_PIP_HTH1_SRAM_BASE
#define PIP_TH2_CORE_BASE IPS_PIP_HTH2_CORE_BASE
#define PIP_TH2_SRAM_BASE IPS_PIP_HTH2_SRAM_BASE
#define PIP_TH3_CORE_BASE IPS_PIP_HTH3_CORE_BASE
#define PIP_TH3_SRAM_BASE IPS_PIP_HTH3_SRAM_BASE
#define CORE_REGS_t HTH0_CORE_REGS_t
#define SRAM_REGS_t HTH0_SRAM_REGS_t
#define CORE HTH0_CORE
#define SRAM_ALUT_FIELD_REPLACE_VAL HTH0_SRAM_ALUT_FIELD_REPLACE_VAL


#define FHS_REGS_t FHS_4CH_REGS_t
#define PIP_FHS_BASE IPS_PIP_FHS_4CH_BASE
#define PIP_FHS6_BASE IPS_PIP_FHS_6CH_BASE
#define FHS FHS_4CH  // use the same macros for FHS_6CH


#define TP_CONTONE_REGS_t CP_REGS_t
#define PIP_CP_BASE IPS_PIP_CP_BASE 

#define TP_TEXT_REGS_t TP_REGS_t
#define PIP_TP_BASE IPS_PIP_TP_BASE 

#define PIP_CR_BASE IPS_PIP_CR_BASE

#define PIP_SC_CSC_BASE IPS_PIP_SCCSC_BASE

#define PIP_UED_BASE IPS_PIP_UED_BASE
// #define UED_REGS_t UED_BASIC_REGS_t 
#define UED_SN UED

// #define ODMA ODMA_SLI  // granite definition
//#define ODMA_REGS_t ODMA_SLI_REGS_t // granite definition

#define ODMA ODMA0 // granite2 definition 
#define ODMA_REGS_t ODMA0_REGS_t
#define PIP_ODMA0_BASE IPS_PIP_ODMA0_BASE
#define PIP_ODMA1_BASE IPS_PIP_ODMA1_BASE
#define PIP_ODMA2_BASE IPS_PIP_ODMA2_BASE
#define PIP_ODMA3_BASE IPS_PIP_ODMA3_BASE
...
#define PA_IDMA PA_PA_IDMA
#define PA_IDMA_REGS_t PA_PA_IDMA_REGS_t
#define PIP_PA_PA_IDMA_BASE IPS_PIP_PA_PA_IDMA_BASE
#define PA_ODMA PA_PA_ODMA
#define PA_ODMA_REGS_t PA_PA_ODMA_REGS_t
#define PIP_PA_PA_ODMA_BASE IPS_PIP_PA_PA_ODMA_BASE
//#define NGA_REGS_t NGADJUST_DAVINCI_REGS_t // granite
#define PIP_NGA_BASE IPS_PIP_NGA_BASE
#define PIP_YIPI_BASE IPS_PIP_YIPI_BASE
#define PIP_STATS_BASE IPS_PIP_PIP_STATS_BASE

#define PIP_SERP_BASE IPS_PIP_SERP_BASE
#define PIP_DB_SERP_BASE IPS_PIP_DB_SERP_BASE
#define DB_REGS_t DB_SERP_REGS_t
#define PIP_DB_HT_BASE IPS_PIP_DB_HT_BASE // ued
#define PIP_CRE_BASE IPS_PIP_CRE_BASE

#define PIP_MIP_BASE IPS_PIP_MIP_BASE
#define MIP_REGSET_REGS_t MIP_REGS_t 



#ifdef ASIC_granite2
#define CSC_REGS_t CSC_SR2Y_REGS_t    // granite2 
#endif
#define CSC CSC_SR2Y
