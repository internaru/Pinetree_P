...
typedef struct
{
    ...
    wlan_phy_handle_t phy_hndl; // TODO TEMP for pwr mgr
...
net_wlan_context_t *net_wlan_get_ctxt(void);

//=========================================================================================================================
// rdj TEMP - raw socket stuff - move to eth_mac module after completing net_wlan and wlan_mac module refactoring
//=========================================================================================================================
 ...
 */
typedef void (*net_wlan_notify_callback_t)( uint16_t ether_type );
 ...
 * \return -1 on error
 */
error_type_t net_wlan_notify_callback_register( uint16_t ether_type, net_wlan_notify_callback_t callback );
 ...
 * \return -1 on error
 */
int wlan_link_raw_send( char *data_ptr, int data_len );
